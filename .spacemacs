...
you should place your code here."
  ...
  ;; If the powerline separators on the spaceline are a different (less saturated) color than the rest of the line, you can add following snippet to dotspacemacs/user-config in your .spacemacs file.
  ...
  ;; Use Mac keyboard Option key for €#¢ signs
  (setq-default mac-right-option-modifier nil)

  ;; Visual line navigation globally on
